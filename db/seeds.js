      ...
      .create([
        {
          ...
          author: users[0].id,
          date: `${date}`,
          coverPic: 'https://cdn-images-1.medium.com/max/2000/1*gFJk0Um7FrS91DELFn1RpQ.png',
...

        {
          ...
          author: users[2].id,
          date: `${date}`,
          coverPic: 'https://cdn-images-1.medium.com/max/2000/1*uwBtz0on4opsXRrN7hI58g.png',
...

        {
          ...
          author: users[3].id,
          date: `${date}`,
          coverPic: 'https://cdn-images-1.medium.com/max/2000/1*FeeJL5lByeJbZ27kBqVhSQ.png',
...

        {
          ...
          author: users[0].id,
          date: `${date}`,
          coverPic: 'https://cdn-images-1.medium.com/max/2000/1*e501kx3kYlMvO04CBiZBog.jpeg',
...

        {
          ...
          author: users[0].id,
          date: `${date}`,
          coverPic: 'https://cdn-images-1.medium.com/max/1600/1*SKsJTsScka5cjCKae8mMbA.png',
...

        {
          ...
          author: users[0].id,
          date: `${date}`,
          coverPic: 'https://cdn-images-1.medium.com/max/2000/1*0aJjQItzwBtV6cI7xjD5sQ.png',
